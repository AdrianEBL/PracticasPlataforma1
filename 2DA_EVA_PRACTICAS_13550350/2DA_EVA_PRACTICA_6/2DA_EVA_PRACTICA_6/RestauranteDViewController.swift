//
//  RestauranteDViewController.swift
//  2DA_EVA_PRACTICA_6
//
...
class RestauranteDViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    var sTexto = ""
    var sImagen = ""
    let asData = ["Manzana", "Pera", "Guayaba", "Piña", "Sandia"]
    let secData = ["Cereal", "Galletas", "Azucar", "Nieve", "Pay"]
