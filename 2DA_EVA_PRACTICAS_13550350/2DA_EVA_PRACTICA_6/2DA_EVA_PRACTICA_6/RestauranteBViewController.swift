//
//  RestauranteBViewController.swift
//  2DA_EVA_PRACTICA_6
//
...
class RestauranteBViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    var sTexto = ""
    var sImagen = ""
    let asData = ["Pan", "Tortilla", "Tostada", "Galleta", "Panque"]
    let secData = ["Huevos", "Frijoles", "Jamon", "Tocino", "Omelet"]
