//
//  RestauranteEViewController.swift
//  2DA_EVA_PRACTICA_6
//
...
class RestauranteEViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    var sTexto = ""
    var sImagen = ""
    let asData = ["Helado", "Pastel", "Pay", "Gelatina", "Churros"]
    let secData = ["Chocolate", "Vainilla", "Miel", "Maple", "Azucar"]
